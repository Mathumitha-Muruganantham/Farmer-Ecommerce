    ...
    >
      ...
      <div className="flex flex-col items-center justify-center gap-2 p-10 md:p-8 sm:p-6 bg-black bg-opacity-70 text-white rounded-lg w-[500px] max-w-full">
        ...
        <input type="tel" placeholder="Phone Number" value={phone} onChange={(e)=>setPhone(e.target.value)}
          className="w-full p-3 text-black rounded-md mb-4 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500"
        />
         <div className="flex flex-row justify-center item-center gap-x-3">
        <label className="text-lg sm:text-base mb-2 lg:text-2xl">Select Gender</label>
        <input type="radio"  value="Male" className="w-5 h-5 accent-green-500 lg:text-2xl" checked={gender==="Male"} onChange={handleGender}/>  <span className="hover:text-green-500 transition duration-300">Male</span>
        <input type="radio"  value="Female" className="w-5 h-5 accent-green-500 lg:text-2xl" checked={gender==="Female"} onChange={handleGender}/>  <span className="hover:text-green-500 transition duration-300">Female</span>
        </div>
