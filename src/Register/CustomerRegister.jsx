      ...
      <div className="flex flex-col items-center justify-center gap-2 p-10 md:p-8 sm:p-6 bg-black bg-opacity-70 text-white rounded-lg w-[500px] max-w-full">
        ...
        <div className="flex flex-row justify-center item-center gap-x-3">
          ...
          <input 
            type="radio"  
            value="Male" 
            className="w-5 h-5 accent-green-500 lg:text-2xl" 
            checked={gender === "Male"} 
            onChange={handleGender} 
          />  
          <span className="hover:text-green-500 transition duration-300">Male</span>
          ...
          <input 
            ...
            onChange={handleGender} 
          />  
          <span className="hover:text-green-500 transition duration-300">Female</span>
        </div>
