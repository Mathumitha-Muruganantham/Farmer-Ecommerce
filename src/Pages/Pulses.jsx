...
function Millets() {
    const millets=[
        {name:"Ragi",price:"₹30/kg",img:"https://images.pexels.com/photos/209439/pexels-photo-209439.jpeg?auto=compress&cs=tinysrgb&w=400"},
        {name:"",price:"₹20/kg",img:"https://images.pexels.com/photos/327098/pexels-photo-327098.jpeg?auto=compress&cs=tinysrgb&w=400"},
        ...
        {name:"Jackmillet",price:"₹30/kg",img:"https://media.istockphoto.com/id/1326743665/photo/jackmillet-with-green-leaf-background.jpg?b=1&s=612x612&w=0&k=20&c=gpe_8K0oj6m_P6d-dvaRI2TNs4KIjm4EbntXM2x3Hb8="},
  ...
  return (
      ...
      <div className="bg-green-100">
        <Header />
        <br />
        <h1 className='lg:text-4xl font-bold text-center'>millets</h1>
        <section className='grid grid-cols-3 sd:grid-col-1 gap-4 px-10 py-20'>
            {millets.map((millet,index)=>(
             ...
             <img src={millet.img} alt={millets.name} className='w-full h-40 object-cover rounded-md mb-3'></img>
             <h3 className="text-xl font-semibold">{millet.name}</h3>
              <p className="text-green-700 font-bold">{millet.price}</p>
